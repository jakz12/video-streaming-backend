...
const logoutUser = asyncHandler( async (req, res) => {
    ...
    return res.status(200).clearCookie("accessToken",options).clearCookie("refereshToken",options).json(
...
const refereshAccessToken = asyncHandler( async (req, res) => {
    ...
    try {
        ...
        return res.status(200).cookie("accessToken", accessToken, options).cookie("refereshToken", newRefereshToken,options).json(
            new ApiResponse(200,
                {accessToken, refereshToke: newRefereshToken},
...
const updateUserAvatar = asyncHandler( async (req, res) => {
    ...
    // TODO: Delete previous image save successfully upload new image utility function
...
export { registerUser, loginUser, logoutUser, refereshAccessToken, changeCurrentUserPassword, getCurrentUser, updateAccountDetails, updateUserAvatar, updateUserCoverImage, getUserChannelProfile, getWatchHistory }